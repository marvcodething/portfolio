  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Social icons — cyan/orange alternating */}
        <motion.div variants={itemVariants} className="flex items-center space-x-1">
          ...
          >
            <svg
              ...
              className={`h-5 w-5 transition-all duration-300 group-hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.9)] ${isSWE ? "fill-stone-400 group-hover:fill-cyan-300" : "fill-stone-500 group-hover:fill-cyan-500"}`}
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={`h-5 w-5 transition-all duration-300 group-hover:drop-shadow-[0_0_10px_rgba(249,115,22,0.9)] ${isSWE ? "fill-stone-400 group-hover:fill-orange-400" : "fill-stone-500 group-hover:fill-orange-500"}`}
              viewBox="0 0 24 24"
            >
          ...
          >
            <MdEmail
              className={`h-6 w-6 transition-all duration-300 group-hover:drop-shadow-[0_0_10px_rgba(249,115,22,0.9)] ${isSWE ? "fill-stone-400 group-hover:fill-orange-400" : "fill-stone-500 group-hover:fill-orange-500"}`}
            />
          </motion.a>
        </motion.div>
