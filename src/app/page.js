        ...
        <div className="flex space-x-4">
          ...
          >
            <svg
              ...
              className="h-5 w-5 fill-stone-300 transform transition-all duration-300 hover:scale-125 hover:fill-white hover:drop-shadow-[0_0_20px_rgba(236,72,153,1)] hover:filter hover:brightness-150"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 fill-stone-300 transform transition-all duration-300 hover:scale-125 hover:fill-white hover:drop-shadow-[0_0_20px_rgba(236,72,153,0.9)] hover:filter hover:brightness-150"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <a
            ...
            className="p-2 transition-all duration-300"
          >
            <MdEmail className="h-6 w-6 fill-stone-300 transform transition-all duration-300 hover:scale-125 hover:fill-white hover:drop-shadow-[0_0_20px_rgba(236,72,153,0.9)] hover:filter hover:brightness-150" />
          </a>
        </div>
      </motion.div>
